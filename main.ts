...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.End, function (sprite, otherSprite) {
    ...
    statusbar.value += sprites.readDataNumber(sprite, "HP") * -1
    EnemysInWave += -1
})
function createEnemy1 () {
    Enemy1 = sprites.create(img`
        ...
        . . . c c c c c c c c b b . . . 
        `, SpriteKind.Enemy)
    sprites.setDataNumber(Enemy1, "HP", 5)
    sprites.setDataNumber(Enemy1, "Defense", 1)
    sprites.setDataNumber(Enemy1, "Speed", 40)
    statusbar2 = statusbars.create(20, 4, StatusBarKind.EnemyHealth)
    statusbar2.max = sprites.readDataNumber(Enemy1, "HP")
    statusbar2.value = sprites.readDataNumber(Enemy1, "HP")
    statusbar2.attachToSprite(Enemy1)
    tiles.placeOnTile(Enemy1, StartSprite.tilemapLocation())
    scene.followPath(Enemy1, item, sprites.readDataNumber(Enemy1, "Speed"))
}
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (mySprite.tileKindAt(TileDirection.Center, sprites.castle.tileGrass1)) {
        createTower(250, "Tower", 1, 75, 2, img`
            . . . . . . . . . . . . . . . . 
            . . f f f . f f f f . f f f . . 
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (mySprite.tileKindAt(TileDirection.Center, sprites.castle.tileGrass1)) {
        createTower(100, "Cat", 0.5, 50, 1, img`
            e e e . . . . e e e . . . . 
            c d d c . . c d d c . . . . 
            c b d d f f d d b c . . . . 
            c 3 b d d b d b 3 c . . . . 
...
game.onUpdate(function () {
    ...
    HPHUD.setText("" + statusbar.value + "/" + statusbar.max)
    ...
    for (let value of sprites.allOfKind(SpriteKind.Tower)) {
        ...
        if (Target && sprites.readDataBoolean(value, "canAttack")) {
            ...
            projectile = sprites.createProjectileFromSprite(img`
                ...
                . . . . . . . . . . . . . . . . 
                `, value, 0, 0)
            spriteutils.setVelocityAtAngle(projectile, spriteutils.angleFrom(value, Target), 150)
